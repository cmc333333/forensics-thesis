...
honeynet\_image\_a} and {\tt gunzip\_a}? Where did {\tt file23} and the {\tt
maliciousFileName}s come from? How does {\tt borland\_reflection} work? While
...
Honeynet example in detail in \ref{subsec:unknown}.
